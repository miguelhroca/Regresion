...
La práctica 1 de la asignatura _Machine Learning_ se divide en dos partes, una de **Regresión** y otra de **Clasificación**. Esta plantilla se corresponde con la primera parte. En ella habrá que trabajar con un problema de regresión que se define a continuación.

## Requisitos de la práctica
La práctica consta de los siguientes entregables:

1. Dos plantillas de libretas de _Python_ en las cuales se realizará el desarrollo de la práctica, una para regresión (ésta) y otra para clasificación (disponible en el Moodle de la asignatura)
2. Un vídeo corto de alrededor de 15 minutos en el cual se presenten los desarrollos, resultados y conclusiones obtenidas tanto para el problema de **regresión** como el de **clasificación**
